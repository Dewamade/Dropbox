...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1781756797);
user_pref("app.update.lastUpdateTime.background-update-timer", 1781756797);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1781769214);
user_pref("app.update.lastUpdateTime.glean-addons-daily", 1781756797);
user_pref("app.update.lastUpdateTime.region-update-timer", 1781756797);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1781770596);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1781756797);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 0);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1781756797);
user_pref("app.update.migrated.updateDir3.AF37698AA10BA0A0", true);
user_pref("app.update.mode", 0);
user_pref("app.update.service.enabled", false);
user_pref("apz.content_response_timeout", 60000);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contextual-services.contextId", "47bfe479-3b98-474e-b7dd-7d4349f04598");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1781756768);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{9544ea67-14cb-49b9-8f46-ad92c5030130}");
...
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20260611193205");
user_pref("browser.shell.checkDefaultBrowser", false);
user_pref("browser.startup.couldRestoreSession.count", 2);
user_pref("browser.startup.homepage", "about:blank");
user_pref("browser.startup.homepage_override.mstone", "ignore");
user_pref("browser.startup.lastColdStartupCheck", 1781770597);
...
user_pref("captchadetection.lastSubmission", 1781756);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "c57e931d-5a65-413d-a5a5-764943f66606");
user_pref("datareporting.dau.cachedUsageProfileID", "df98a580-35b3-4c14-83ea-2c4f19eb36c2");
...
user_pref("extensions.webextensions.uuids", "{\"data-leak-blocker@mozilla.com\":\"f60e9c3a-56e6-4d6c-b143-ccd8584d2bbc\",\"formautofill@mozilla.org\":\"899788d6-4293-4ad5-a3a5-ca214beca34d\",\"ipp-activator@mozilla.com\":\"5ae3ce46-122a-48de-9653-fabb927a9d38\",\"pictureinpicture@mozilla.org\":\"7807cd8c-4f5d-4eb7-96c8-cc68b8708b12\",\"addons-search-detection@mozilla.com\":\"157d871a-6f85-4e7d-8676-b444a4b8b585\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"newtab@mozilla.org\":\"b214568c-4e27-4340-912f-5cbf5bcdc323\",\"default-theme@mozilla.org\":\"028d5b25-87a2-439d-9889-3121e26765aa\",\"user-agent-switcher@ninetailed.ninja\":\"80189ecc-e1b6-4824-a333-83173af715ea\",\"jid1-MnnxcxisBPnSXQ@jetpack\":\"08a20f31-e700-4a95-bef8-e7616927230f\"}");
...
user_pref("gfx-shader-check.driver-version", "32.0.11020.26001");
...
user_pref("idle.lastDailyNotification", 1781765970);
...
user_pref("media.gmp-manager.buildID", "20260611193205");
user_pref("media.gmp-manager.lastCheck", 1781756890);
user_pref("media.gmp-manager.lastEmptyCheck", 1781756890);
...
user_pref("nimbus.profileId", "e6f37c83-5d77-4055-95e8-ed8a0bf6ea01");
user_pref("pdfjs.disabled", true);
user_pref("pdfjs.enabledCache.state", false);
user_pref("permissions.isolateBy.userContext", true);
user_pref("places.database.lastMaintenance", 1781765970);
user_pref("plugin.state.flash", 0);
user_pref("privacy.bounceTrackingProtection.hasMigratedUserActivationData", true);
user_pref("privacy.clearOnShutdown_v2.formdata", true);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1781765970904");
...
user_pref("sanity-test.driver-version", "32.0.11020.26001");
...
user_pref("storage.vacuum.last.places.sqlite", 1781765970);
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.profiles.storeID", "af0c2c75");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1781770593);
