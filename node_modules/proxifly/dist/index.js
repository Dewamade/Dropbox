...
// node_modules/wonderful-fetch/dist/index.mjs
...
var SOURCE = "library";
var VERSION = "3.0.1";
var API_HOST = "https://api.proxifly.dev";
var Proxifly = class {
  constructor(options = {}) {
    this.options = {
      apiKey: "",
...
Proxifly.version = VERSION;
async function request(instance, options) {
  const { path, timeout, query } = options;
  const url = `${instance.options.url}${path}`;
  return index_default(url, {
    method: "get",
    response: "json",
    timeout,
    query,
    authorization: instance.options.apiKey ? `Bearer ${instance.options.apiKey}` : void 0,
    cacheBreaker: false,
    log: instance.options.debug
  });
}
